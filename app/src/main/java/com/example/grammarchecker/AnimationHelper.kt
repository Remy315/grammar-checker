    ...
    companion object {
        ...
        fun createConfettiAnimation(container: ViewGroup) {
            for (i in 0 until 8) {
                ...
                val fallAnimation = ObjectAnimator.ofFloat(confetti, "translationY", 0f, 200f)
                fallAnimation.duration = 1500
                fallAnimation.startDelay = (i * 100).toLong()
                fallAnimation.start()
                
                val fadeAnimation = ObjectAnimator.ofFloat(confetti, "alpha", 1f, 0f)
        ...
        fun createGreenSlideAnimation(view: View) {
            val drawable = GradientDrawable(
                ...
                intArrayOf(Color.TRANSPARENT, ContextCompat.getColor(view.context, R.color.correct_green))
            )
            ...
            if (view.parent is ViewGroup) {
                ...
                val layoutParams = ViewGroup.LayoutParams(view.width, view.height)
                parent.addView(overlayView, index + 1, layoutParams)
                
                val slideAnimation = ObjectAnimator.ofFloat(overlayView, "translationX", -view.width.toFloat(), view.width.toFloat())
                slideAnimation.duration = 800
                slideAnimation.start()
                
                slideAnimation.addListener(object : AnimatorListenerAdapter() {
                    override fun onAnimationEnd(animation: Animator) {
        ...
        fun showSuccessToast(view: View, message: String) {
            ...
            if (overlay is ViewGroup) {
                ...
                toastView.setBackgroundColor(ContextCompat.getColor(view.context, R.color.correct_green))
                ...
                val slideIn = ObjectAnimator.ofFloat(toastView, "translationY", -100f, 0f)
